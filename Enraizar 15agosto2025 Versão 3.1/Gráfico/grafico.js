// Simula a leitura dos dados do diário emocional
// (no seu sistema real, pode puxar do localStorage ou banco de dados)
const dadosSalvos = JSON.parse(localStorage.getItem("humorData")) || {};
